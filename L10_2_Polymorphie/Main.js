...
(function (L10_2_PolymorphieAnimation) {
    ...
    function handleLoad(_event) {
        ...
        let back = new L10_2_PolymorphieAnimation.Background();
        ...
        for (let i = 0; i < 3; i++) {
            let newSeagull = new L10_2_PolymorphieAnimation.Seagull();
        ...
        //Wolken platzieren
        for (let i = 0; i < 10; i++) {
            let newCloud = new L10_2_PolymorphieAnimation.Cloud();
    ...
    function createShip(n) {
        for (let index = 0; index < n; index++) {
            let ship1 = new L10_2_PolymorphieAnimation.Ship();
